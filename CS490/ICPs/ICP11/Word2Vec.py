...
# Model Learning Rate
#changing the learing rate from 1.0 to .02 decreaseses the avg loss 
learning_rate = 0.2
...
with tf.Session() as sess:
    ...
    writer.close()
    saver.save(sess, './DeepLearing2/my_model.ckpt')
...
#taking too long to plot. Reduced the plot from 2000 to 200
plot_only = 200
