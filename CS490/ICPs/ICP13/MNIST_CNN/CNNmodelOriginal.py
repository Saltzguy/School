...
import os
fname = len([name for name in os.listdir('data2') if os.path.isdir(os.path.join('data2', name))])
fname = "data2/" + str(fname)
...
train_step = tf.train.GradientDescentOptimizer(.03).minimize(cross_entropy)
