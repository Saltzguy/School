...
DATA_FILE = 'home/saltguy/Desktop/CS490data/Smoking.xls'
...
# Step 2: create placeholders for input X1 Smoking status, X2 Age classification
...
plt.plot(X2, X1,'bo', label='Real data')
plt.plot(Y, X1 * w1 + X2 * w2 + b, 'r', label='Predicted data')
plt.legend()
plt.show()